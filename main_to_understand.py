...
db.init_db() # initialize the database and seed it for initial data if empty.

app=FastAPI(title="TimeTrack",description="A simple time traking app with rest and MCP endpoints.")
...
# uvicorn main_to_understand:app --port 9998 --reload


# MCP Server code start
